    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p class="mb-1"><i class="fas fa-envelope-open-text"></i> <a href="mailto:contato@bellaestetica.com" class="text-light">contato@bellaestetica.com</a></p>
                <p><i class="fas fa-phone"></i> (21) 99440-2004</p>
            </div>
            <div class="col-md-4">
